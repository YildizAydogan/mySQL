...
select concat(musteri_no, '.', ad, ' ', soyad) kisisel_bilgiler, sehir, cinsiyet, puan from customer;
...
select ad, concat(left(ad,1), right (left(ad,3),1), right(left(ad,5),1)) bir_uc_bes
from customer;
-- 2 . cozum

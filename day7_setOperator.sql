...
------------------------------------------------------------------------------*/
select isim as isim_sehir, maas -- _ isareti snakecase, - isareti kebabcase, buyuk kucuk harliyse camelcase
from personel
where maas>4000
union
select sehir, maas
...
union
select isim from personel where sirket='Toyota';
/* -----------------------------------------------------------------------------
...
select isim, maas, sirket
from personel
where sirket<>'honda' and maas<5000;

...
--    DELETE FROM ogrenciler;     -- Tüm verileri sildi ama tablo hala var savepointin icinde.
--    ROLLBACK TO  ABC;  -- Silinen Verileri geri getir nerden? kaydoldugu abc savepointinin icinden.
